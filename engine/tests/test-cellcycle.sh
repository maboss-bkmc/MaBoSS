...
# python compare_probtrajs.py refer/Cell_cycle_thread_6_probtraj.csv tmp/Cell_cycle_thread_6_probtraj.csv
# check_file "projtraj"
...
# python compare_probtrajs.py tmp/Cell_cycle_thread_1_probtraj.csv tmp/Cell_cycle_thread_6_probtraj.csv --exact # || echo '**** error test #3 (multi threads) ****'
# check_file "probtrajs"
# python compare_probtrajs.py tmp/Cell_cycle_thread_1_statdist.csv tmp/Cell_cycle_thread_6_statdist.csv # || echo '**** error test #3 (multi threads) ****'
# check_file "statdist"
