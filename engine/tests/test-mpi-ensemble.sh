...
/usr/bin/time -p $LAUNCHER mpirun -np $1 $MABOSS --ensemble --save-individual -c ensemble/ensemble.cfg -o tmp/res ensemble/invasion/Invasion_0.bnet ensemble/invasion/Invasion_200.bnet ensemble/invasion/Invasion_400.bnet ensemble/invasion/Invasion_600.bnet ensemble/invasion/Invasion_800.bnet  ensemble/invasion/Invasion_1000.bnet
